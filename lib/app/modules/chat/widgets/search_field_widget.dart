...
// enum to define the Focus of the SearchFieldWidget when a suggestion is tapped
...
class SearchFieldWidget extends StatefulWidget {
  ...
  /// Hint for the [SearchFieldWidget].
  final String hint;

  /// Define a [TextInputAction] that is called when the field is submitted
  final TextInputAction textInputAction;

  /// The initial value to be selected for [SearchFieldWidget]. The value
  ...
  /// Specifies the `TextEditingController` for [SearchFieldWidget].
  final TextEditingController controller;

  /// `validator` for the [SearchFieldWidget]
  /// to make use of this validator, The
  /// SearchFieldWidget widget needs to be wrapped in a Form
  ...
  /// the SearchFieldWidget along the Y-axis.
...
class _SearchFieldWidgetState extends State<SearchFieldWidget> {
  final StreamController<List<UserModel>> sourceStream =
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.initialValue == null) {
        ...
        sourceController.text =
            widget.initialValue.firstName + widget.initialValue.lastName;
          ...
          return AnimatedContainer(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => GestureDetector(
                onTap: () {
                  sourceController.text = snapshot.data[index].firstName +
                  ...
                  if (widget.onTap != null) {
                    widget.onTap(snapshot.data[index].firstName +
                        snapshot.data[index].lastName);
                  }
                },
                child: Container(
    ...
    return OverlayEntry(
        builder: (context) => StreamBuilder<List<UserModel>>(
            ...
            builder: (BuildContext context,
              ...
              var count = widget.maxSuggestionsInViewPort;
